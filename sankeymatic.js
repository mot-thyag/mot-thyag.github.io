    ...
    textObjs.forEach((tspan) => {
      ...
      if (tspan.newLine) {
        ...
        d3selection.append('tspan')
          ...
          .attr('fill', tspan.color) // Apply the color here
          .text(tspan.txt);
  ...
  function getLabelPieces(n, magnification) {
    const overallSize = cfg.labelname_size * magnification,
      ...
      nameObjs = nameParts.map((part, i) => ({
        ...
        size: i === 0 ? nameSize : nameSize * 0.8, // Reduce size by 80% for text after \n
        color: i === 0 ? cfg.labels_color : 'grey', // Set color to grey for text after \n
        newLine: i > 0
